...
//   },
   ...
   audioAuthor: '许巍',
      ...
      handleProxy: function handleProxy (e) {
        ...
        console.log('3');
        var t = this;
        if (e.currentTarget.dataset.type == "jia") {
          t.jia();
        }
      ...
      handleCan: function handleCan (e) {
        console.log(e.currentTarget.dataset.can);
        var can = e.currentTarget.dataset.can;
        if (can) {
          wx.request({
            url: 'https://wxadmin.kangyichina.cn/api/order/cancel',
            data:{
              can:can
            },
            success(res){
      ...
      onLoad: function onLoad (query) {
        ...
        if (query.id) {
          ...
          wx.request({
            ...
            success(res){
              t.setData({goods_info:res.data.result})
            }
          })
        }
      ...
      onShow: function onShow () {
        ...
        this.setData({tabxp_active:1,jia:0})
        this.setData({bal:0});
      ...
      //拨打电话
      detshow:function(e){
        this.setData({tabxp_active:e.currentTarget.dataset.comkey});
        var id = e.currentTarget.dataset.id
        var t = this;
        wx.request({
          url: 'https://wxadmin.kangyichina.cn/api/comment/get',
          data:{id:id},
          success(res){
        ...
        wx.request({
          url: 'https://wxadmin.kangyichina.cn/api/comment/count',
          data:{id:id},
          success(res){
            t.setData({count:res.data.result})
          }
        })
      },
      detail_t:function(e){
      ...
      block:function(e){
        if (e.currentTarget.dataset) {
          this.setData({order:e.currentTarget.dataset})
          var t = this;
          wx.request({
            url: 'https://wxadmin.kangyichina.cn/api/comment/getgoods',
            data:{
            ...
            success(res){
              ...
              if (res.data.result) {
                ...
                console.log(goods);
                goods.pic = 'https://kangy.oss-cn-beijing.aliyuncs.com/'+res.data.result.pic;
                t.setData({goods:goods})
              } else {
                t.setData({goods:0})
              }
            }
      ...
      goo:function(e){
        // console.log(e);
        this.setData({good:e.currentTarget.dataset.num})
      },
      comment:function(e){
        var t = this;
        ...
        wx.request({
          url: 'https://wxadmin.kangyichina.cn/api/comment/set',
          data:{
          ...
          success(res){
            if (res.data == 1) {
              ...
              setTimeout(function () {
                t.setData({show:0})
                wx.navigateTo({
                  url: '/pages/normal/detail/main?id='+goods.id,
                })
              }, 2000)
            } else {
              wx.showToast({
      ...
      bo:function(){
        ...
        innerAudioContext.src = 'https://kangy.oss-cn-beijing.aliyuncs.com/kangyi/cate/5ea7da6cd4746.mp3'
      ...
      more:function(e){
        var id = e.currentTarget.dataset.id;
        wx.navigateTo({
          url: '/pages/normal/comment/comment?id='+id
        })
      },
      jia:function(){
        this.setData({jia:1})
        ...
        animation.translate(0,0).step({duration: 5})
        t.setData({animation: animation.export()})
        setTimeout(function(){
          animation.translate(-50,100).step({duration: 600,timingFunction:'ease'})
          t.setData({animation: animation.export()})
          setTimeout(function(){
            console.log(1)
            t.setData({jia:0})
...
function change(goods, buynumber) {
    ...
    var shopingcar = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.cache("shopingcar");
    if (shopingcar == null) {
        shopingcar = [];
    }
    var _index = -1;
    ...
    if (newnumber > goods['number']) {
        __WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.toast(goods.name + "库存不足");
        return;
    }
    if (newnumber < 1) {
        del(goods.id);
    ...
    __WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.cache("shopingcar", shopingcar);
}

function get() {
    var buylist = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.cache("shopingcar");
    if (!(buylist instanceof Array)) {
        return [];
    }
    return buylist;
}
function clear() {
    console.log("clear");
    __WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.cache("shopingcar", "del");
}
...
function del(id, cb) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.cache("shopingcar", newlist);
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wxDiscode__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__htmlparser__ = __webpack_require__(92);
/**
